...
from utils import (convert_meters_to_pixel_distance, convert_pixel_distance_to_meters, 
                   get_foot_position, get_closest_keypoint_index, get_height_of_bbox, measure_distance, 
                   get_center_of_bbox, measure_xy_distance)
...
class MiniCourt():
    ...
    def set_court_lines(self):
        self.lines = [(0, 2),(4, 5),(6,7),(1,3),(0,1),(8,9),(10,11),(10,11),(2,3)]
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            for player_id, bbox in player_bbox.items():
                ...
                mini_court_player_position = self.get_mini_court_coordinates(foot_position,
                                                                            ...
                                                                            player_heights.get(player_id, constants.DEFAULT_PLAYER_HEIGHT_METERS)
                                                                            )
